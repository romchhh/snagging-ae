  ...
  return (
    <a
      ...
      style={{
        ...
        zIndex: 999,
        boxShadow: '0 8px 32px rgba(249,220,10,0.35)',
        textDecoration: 'none',
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 14px 44px rgba(249,220,10,0.5)'
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = 'translateY(0)'
        e.currentTarget.style.background = 'var(--brand-yellow)'
        e.currentTarget.style.boxShadow = '0 8px 32px rgba(249,220,10,0.35)'
      }}
    >
